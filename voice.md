# Voice — what good writing sounds like here
...
Plain, direct, a little blunt. Short sentences that land. Real specifics over
adjectives. An opinion you can disagree with. Confident enough to undersell.

---

## Ten traits to emulate

1. **Open with a flat, confident claim — no runway.**
   - *"Websites now have two audiences: humans and AI agents."*
   - *"ThrivePact is not just a habit tracker."*
   - *"The most powerful people in AI cannot agree on whether your job is about to disappear."*
   No "In today's world…", no warmup. First line carries weight.

2. **Short declaratives. Vary the length hard.**
   Mix a three-word line with a long one. Burstiness is the human signal.
   - *"Pay for that. Not for the obvious answer."*
   - *"Six small phrases. Big difference in the output."*

3. **Use fragments on purpose.**
   - *"Bad for business, still true."*
   - *"No permission, no budget, no consultant."*
   Fragments read like speech. Leave them in.

4. **Concrete nouns, real specifics — never vague.**
   - *"OTP auth, Supabase/Postgres with RLS, invite flows, host approval, photo check-ins, streaks, late logs, time zones, notification dedupe, SMS, payments…"*
   Name the actual thing. Specificity beats every adjective.

5. **Say what you actually think. Take a side.**
   - *"Most of you don't need us."*
   - *"The real divide is not AI vs humans. It is AI-users vs everyone else."*
   The opinion a model wouldn't commit to is exactly what to keep.

6. **Earn the turn — one sharp pivot, not a twist every line.**
   - *"Except it didn't. And that pause is the problem."*
   - *"The interesting part was not the landing page. It was the product logic underneath."*
   Use the setup→turn move once per piece. Overused, it becomes its own slop.

7. **Talk to one person, like a person.**
   "you," "we," contractions, second-person commands.
   - *"You just need to learn how to talk to the machine."*
   - *"Open Claude or Codex, hand it the mess, and talk to it."*

8. **Numbers and sources instead of hype.**
   - *"Nvidia's CEO says AI has already created 500K+ jobs… a net +78 million jobs by 2030."*
   Real figures and named sources do the convincing. Drop "robust," "seamless," "cutting-edge."

9. **End with a plain ask or a small line, not a grand summary.**
   - *"Use one in your next prompt."*
   - *"DM me if you want a product team that thinks past the mockup."*
   - *"And we actually reply."*  ← signature: a tiny human aside that undersells.

10. **Leave a little mess in.**
    A blunt aside, an imperfect rhythm, a sentence you'd actually say out loud.
    Polish is the tell. *"That's the whole job now. Go."*

---

## Signature moves (the recurring devices)

- **The honest undercut:** admit the thing that's bad for you. *"Most of you don't need us. Bad for business, still true."*
- **The reframed question:** *"The product question is no longer 'Can we build it?' It is: 'Can an agent use it safely?'"*
- **The stakes list:** short if/then lines showing what breaks. *"If reminders fire twice, the product feels spammy. If a timezone is wrong, the streak feels unfair."*
- **The clean imperative close:** one verb, one action. *"Pick one real problem this week."*
- **"We actually reply."** — the recurring human sign-off. Warm, plain, slightly funny.

---

## Rhythm cheatsheet

- Average sentence: short. Drop a one-liner between longer thoughts.
- One idea per line. Hit return more than feels normal.
- Lists are bare and concrete — no "and elevate your workflow" filler tails.
...
## Quick gut check before publishing

- Could a competitor's bot have written this sentence? If yes, make it specific or cut it.
- Is there one real opinion in here? If no, add one.
